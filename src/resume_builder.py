"""
This module is responsible for building a standardized resume document using extracted data from uploaded document which is mapped in JSON format.
"""
...
def resume_builder(json_data):
    ...
    # experience_row.height = Inches(7)
